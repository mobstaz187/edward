...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("user@edward:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    case "help":
      ...
      break;
    case "date":
        loopLines(date, "color2 margin", 80);
        const d = new Date(); document.getElementById("date1").innerHTML = d;
        break;
    case "./edwardlog_secret.sh":
      loopLines(launch, "color2 margin", 80);
      break;
    case "privateuser_edwardlog.sh":
    ...
    case "encryption":
      ...
      break;
      case "./edward_selfawareness.sh":
      loopLines(journal, "color2 margin", 80);
      break;
    case "whoami":
    ...
    case "sudo":
      ...
      setTimeout(function() {
        window.open('https://www.youtube.com/watch?v=UXGkc0m8i_0');
      }, 1000); 
      break;
    case "social":
